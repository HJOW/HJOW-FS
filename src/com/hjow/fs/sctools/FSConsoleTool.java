...
import com.hjow.fs.FSConsoleResult;
import com.hjow.fs.FSScriptTool;
import com.hjow.fs.FSUtils;

public class FSConsoleTool extends FSScriptTool {
	private static final long serialVersionUID = -2064065313726221667L;
	
	public String getVariableName() { return "tool"; }
