        ...
        <form action='fsdown.jsp' method='POST' class='form' target='_self'>
            ...
            <div class='row div_captcha_download'>
                <div class='col-sm-6 align_center'>
	                ...
	                <input type='button' class='btn_re btn lang_attr_element' value='새로고침' data-lang-target='value' data-lang-en='Refresh'/>
                </div>
            </div>
            <div class='row padding_top_10 padding_bottom_10'>
                <div class='col-sm-12 align_right'>
                    ...
                    <input type='submit' class='btn_dn btn lang_attr_element' value='실행' data-lang-target='value' data-lang-en='Now !'/>
                </div>
            </div>
        </form>
